...
import { Dumbbell, Moon, ArrowRight, Plus } from "lucide-react";
          ...
          <Link key={dayName} href={`/workout/${dayName.toLowerCase()}`} className="block w-full">
            {plan ? (
              ...
              <motion.div
                whileHover={{ scale: 1.01 }}
                whileTap={{ scale: 0.99 }}
                className={`glass-panel-interactive rounded-2xl p-4 flex items-center justify-between border border-dashed ${
                  isToday
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center border border-dashed border-white/10 text-slate-600">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-medium text-slate-600 mt-0.5 leading-snug">
                      No plan set
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-slate-600">
                  <span className="text-xs font-semibold">Add Plan</span>
